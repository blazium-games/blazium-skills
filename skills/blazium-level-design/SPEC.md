...
Beat maps and spatial metrics. Engine baseline: **Blazium 0.6.x (Godot 4.3.2 fork)**. Do not apply Godot 4.7-only APIs.
...
Do not invent a level-editor API. Pin Blazium 0.6.x (Godot 4.3.2 fork).
