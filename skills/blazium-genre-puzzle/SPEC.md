...
Genre on-ramp so agents compose engine pack skills instead of inventing a puzzle framework.

## What

Compose pinned Blazium skills: ui, input, tilemap, autowork.
...
- Pinned skills: ui, input, tilemap, autowork
